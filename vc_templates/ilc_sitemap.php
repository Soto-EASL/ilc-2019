...
$class_to_filter = 'wpb_ilc_sitemap wpb_content_element ';
if('true' == $center_items) {
    $class_to_filter .= ' ilc-sitmap-center';
}
    ...
    <div class=" <?php echo esc_attr($css_class); ?>" <?php echo implode(' ', $wrapper_attributes); ?>>
        <div class="cr-site-map-wrap">
            <div class="cr-site-map-inner">
                ...
                if ($all_menu_html) {
                    echo '<div class="ilc-sitemap-menu-wrap"><ul class="ilc-sitemap-menu">' . $all_menu_html . '</ul></div>';
                }
                ?>
            </div>
        </div>
